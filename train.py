...
if __name__ == '__main__':
    ...
    parser.add_argument('--ec_factor_decay_steps', type=int, default=1000000)
    ...
    parser.add_argument('--sampling_weight_decay_steps', type=int, default=1000000)

    parser.add_argument('--rb_capacity', type=int, default=5000)
    parser.add_argument('--rl_alg', type=str, default='DQN')
    parser.add_argument('--mfec_buffer_size', type=int, default=2500)
